      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="opacity-40 cursor-not-allowed">
            <div className="bg-surface rounded-2xl p-7 border border-border h-full">
              <div className="text-4xl mb-4">📢</div>
              <h2 className="text-xl font-bold text-text-muted mb-2">Marketing & Communication</h2>
              <p className="text-sm text-text-muted mb-5">Campagnes, contenu et strategie de communication.</p>
              <div className="space-y-1.5 text-sm text-text-muted mb-6">
